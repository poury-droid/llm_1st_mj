...
// TODO: 여기에 코드를 쓰세요
nums3.forEach((num) => console.log(num));
// ───── 문제 4 ───── (개념02 인덱스)
...
// TODO: 여기에 코드를 쓰세요
menu5.forEach((item) => console.log(`${item.name} ${item.price}원`));
// ───── 문제 6 ───── (개념03 map)
...
// TODO: 여기에 코드를 쓰세요
console.log(scores7.map((score) => `${score}점`));
// ───── 문제 8 ───── (개념03 map 속성 뽑기)
...
// TODO: 여기에 코드를 쓰세요
console.log(scores9.filter((s) => s >= 60));
...
// TODO: 여기에 코드를 쓰세요
console.log(products10.filter((item) => item.stock === 0).map((i) => i.name));
// ───── 문제 11 ───── (개념04 find)
...
// TODO: 여기에 코드를 쓰세요
console.log(products10.find((i) => i.name === "케이크").price);
...
// TODO: 여기에 코드를 쓰세요
console.log(products10.findIndex((n) => n.stock === 0));
...
// TODO: 여기에 코드를 쓰세요
console.log(products10.some((i) => i.stock === 0));
console.log(products10.every((i) => i.price >= 5000));
// ───── 문제 14 ───── (개념05 reduce)
...
// TODO: 여기에 코드를 쓰세요
console.log(nums14.reduce((acc, n) => acc + n));
...
// TODO: 여기에 코드를 쓰세요
console.log(cart15.reduce((acc, i) => acc + i.price * i.count, 0));
...
// TODO: 여기에 코드를 쓰세요
const voteCount=votes19.reduce(())
// ───── 문제 20 ───── (에러 확인 — 맨 마지막)
